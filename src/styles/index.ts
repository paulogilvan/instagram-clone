...
export const Flex = styled.div<{ $direction?: string, $align?: string, $justify?: string, $gap?: string, $padding?: string }>`
    position: relative;
    display: flex;
    width: 100%;
...
export const Typography = styled.p<{ $style?: string, $weight?: string, $size?: string, $height?: string }>`
    ${props => css`
